                    ...
                    <nav className={styles.nav}>
                        <div className={styles.navCol}>
                            ...
                            <ul className={styles.navList}>
                                <li><a href="#hero" className={styles.navLink}>{t("Footer.links.home")}</a></li>
                                <li><a href="#education" className={styles.navLink}>{t("Footer.links.education")}</a></li>
                                <li><a href="#experience" className={styles.navLink}>{t("Footer.links.experience")}</a></li>
                                <li><a href="#projects" className={styles.navLink}>{t("Footer.links.projects")}</a></li>
                                <li><a href="#stacks" className={styles.navLink}>{t("Footer.links.stacks")}</a></li>
                                <li><a href="#contact" className={styles.navLink}>{t("Footer.links.contact")}</a></li>
                            </ul>
                        </div>

                        <div className={styles.navCol}>
                            <div className={styles.navTitle}>{t("Footer.titles.services")}</div>
                            <ul className={styles.navList}>
                                <li><a href="#contact" className={styles.navLink}>{t("Footer.links.landing_pages")}</a></li>
                                <li><a href="#contact" className={styles.navLink}>{t("Footer.links.websites")}</a></li>
                                <li><a href="#contact" className={styles.navLink}>{t("Footer.links.erps")}</a></li>
                            </ul>
                        </div>

                        <div className={styles.navCol}>
                            <div className={styles.navTitle}>{t("Footer.titles.focus")}</div>
                            <ul className={styles.navList}>
                                <li><a href="#about" className={styles.navLink}>{t("Footer.links.frontend")}</a></li>
                                <li><a href="#about" className={styles.navLink}>{t("Footer.links.backend")}</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
